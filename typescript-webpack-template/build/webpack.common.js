...
module.exports = {
  resolve: {
    extensions: ['.tsx', '.ts', ".js", ".jsx", ".json", ".vue"], // 可省略后缀
    alias: {
      '@': rootResolve('src')
    }
  },
  entry: {
    main: rootResolve('src/index.ts'),
  },
  output: {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      "process.env": JSON.stringify({ // 传递的值必须字符串化
        ...process.env,
        "VUE_APP_DZHYUN_ADDRESS": "ws://gw.yundzh.com/ws",
        "VUE_APP_DZHYUN_APPID": "6f69c0b9681711ea860b0242ac651206",
        "VUE_APP_DZHYUN_KEY": "kYdnl2Foxg60",
        "VUE_APP_DZHYUN_SHORTID": "00000109",
      })
    }),
    new VueLoaderPlugin(),
    // 编译进度提示
